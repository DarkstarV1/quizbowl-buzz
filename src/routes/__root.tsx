...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Quibbol Buzz" },
      { name: "description", content: "BuzzMaster Pro is a real-time quizbowl buzzer application for creating and joining competitive trivia games." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Quibbol Buzz" },
      { property: "og:description", content: "BuzzMaster Pro is a real-time quizbowl buzzer application for creating and joining competitive trivia games." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Quibbol Buzz" },
      { name: "twitter:description", content: "BuzzMaster Pro is a real-time quizbowl buzzer application for creating and joining competitive trivia games." },
